...
var sites = {
  420: "https://nicenicenice.glitch.me/",
...
function render_open() {
  ...
  setTimeout(function() {
    $("#door").attr(
      "src",
      "https://cdn.glitch.me/49760264-2e6b-484d-9841-f4f99284d5a1/door3.png"
    );
  ...
  $("#door").attr(
    "src",
    "https://cdn.glitch.me/49760264-2e6b-484d-9841-f4f99284d5a1/door2.png"
  );
  door_open = true;
  anim_state = true;
}
...
function render_close() {
  ...
  setTimeout(function() {
    ...
    setTimeout(function() {
      $("#door").attr(
        "src",
        "https://cdn.glitch.me/49760264-2e6b-484d-9841-f4f99284d5a1/door.png"
      );
      anim_state = false;
    }, anim_time);
  }, anim_time);
